...
import com.geekbang.coupon.customer.impl.constant.Constant;
import com.geekbang.coupon.customer.impl.feign.CalculationService;
import com.geekbang.coupon.customer.impl.feign.TemplateService;
    ...
    public SimulationResponse simulateOrderPrice(SimulationOrder order) {
        ...
        for (Long couponId : order.getCouponIDs()) {
            ...
            if (couponOptional.isPresent()) {
                ...
                couponInfo.setTemplate(getTemplateInfo(coupon.getTemplateId()));
...
//        CouponTemplateInfo templateInfo = templateService.loadTemplateInfo(request.getCouponTemplateId());
    ...
    private CouponTemplateInfo getTemplateInfo(Long templateId){
